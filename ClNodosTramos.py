...
class ClNodosTramosEntity():
    ...
    def addNodoTramo(self, id_tramo, id_cl_nodo):
        ...
        idx_id_tramo = self.cl_nodos_tramos_layer.fieldNameIndex("tramo_idtramo")
        idx_cl_nodo = self.cl_nodos_tramos_layer.fieldNameIndex("cl_nodos_id_cl_nodos")
    ...
    def getFeaturesLayer(self):
        return self.cl_nodos_tramos_layer

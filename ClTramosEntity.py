...
class ClTramosEntity():
    ...
    def addAttributes(self, feat_linea, tipo, longitud, diametro, material, conforme):
        ...
        if  self.cl_tramo.dataProvider().changeAttributeValues({ id_tramo : attrs }):
            return True
        else:
            return False
    ...
    def setNullData(self, tramo):
        ...
        #attrs = [None] * len(self.cl_tramo.fields())
    ...
    def changeDirectionTramo(self, dir_select):
        ...
        for tramo in self.cl_tramo.getFeatures():
            ...
            if tramo['gid'] == dir_select['tramo_idtramo']:
        ...
        if self.cl_tramo.dataProvider().changeAttributeValues({dir_select['tramo_idtramo']: attrs}):

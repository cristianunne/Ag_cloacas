...
class ClNodosEntity():
    ...
    def addNodosWithCompletedData(self, tramo_select, ztn_1, n_nod_1, n_rel_1, ty_z_1, ztn_2, n_nod_2, n_rel_2, ty_z_2, cl_nodos_etiqueta_entity, cl_nodos_tramos_layer, cl_nodos_tramos_entity):

        #Consulto si existe el Nodo y procedo segun la respuesta
    ...
    def createNodo(self, feat, cl_nodostramos_entity, tramo_select):
        ...
        if res:
            ...
            if self.cl_nodos_layer.commitChanges():
                ...
                if cl_nodostramos_entity.addNodoTramo(tramo_select['gid'], feat_last['gid']):
    ...
    def addReferenceToNodoTramo(self, cl_nodostramos_entity, feat, tramo_select):
        ...
        if cl_nodostramos_entity.addNodoTramo(tramo_select['gid'], feat['gid']):
            return True
        else:
            return False


    def addNodos(self, tramo_select, ztn_1, n_nod_1, n_rel_1, ty_z_1, ztn_2, n_nod_2, n_rel_2, ty_z_2, cl_nodos_etiqueta_entity, cl_nodos_tramos_layer):
            ...
            if feat_return != False:
                ...
                if i == 0:
                    ...
                    if feat_return["ztn"] == None or feat_return["ztn"] == 0:
                        ...
                        self.cl_nodos_layer.changeAttributeValue(feat_return.id(), idx_ztn, ztn_1, n_nod_1, n_rel_1, ty_z_1)
                        self.cl_nodos_layer.commitChanges()
            ...
            for feat_ in features:
                ...
                if res:
                    ...
                    if self.cl_nodos_layer.commitChanges():
                        ...
                        cl_nodos_etiqueta_entity.addNodo(last_feat_Add.id(), id_tramo, last_feat_Add["ztn"], last_feat_Add.geometry().asPoint())
    ...
    def getExistNodo(self, point):
        ...
        #self.initialize(layer_cl_nodos)
    ...
    """
    def deleteNodos(self, tramo_select, cl_nodos_etiqueta_entity, cl_nodos_tramos_layer):
    ...
    def getInitialNodoByTramoTouches(self, tramo_select):
        ...
        for ver in vertices:
            ...
            feat_point = QgsGeometry.fromPoint(ver)
